...
(function(window, document, exports, global, define, undefined) {
        ...
        function k(a, b, c, d) {
            ...
            this.o(b) ?
                ((this.m = b),
                    ...
                    this.l(),
                    0 === this.length ? m(this.c, this.b) : ((this.length = this.length || 0), this.k(), 0 === this.d && m(this.c, this.b))) :
                g(this.c, this.p());
        }
    ...
    function createWindowClone(ownerDocument, containerDocument, width, height, options, x, y) {
        ...
        return new Promise(function(resolve) {
            ...
            documentClone.replaceChild(
                options.javascriptEnabled === true ? documentClone.adoptNode(documentElement) : removeScriptNodes(documentClone.adoptNode(documentElement)),
        ...
        [].slice.call(ownerDocument.querySelectorAll('[' + html2canvasCanvasCloneAttribute + ']'), 0).forEach(function(canvas) {
            try {
                var clonedCanvas = documentClone.querySelector(
                    '[' + html2canvasCanvasCloneAttribute + '="' + canvas.getAttribute(html2canvasCanvasCloneAttribute) + '"]',
                );
                if (clonedCanvas) {
    ...
    function calculateCurvePoints(bounds, borderRadius, borders) {
        ...
        return {
            ...
            bottomLeftInner: getCurvePoints(x + borders[3].width, y + leftHeight, Math.max(0, blh - borders[3].width), blv - borders[2].width).bottomLeft.subdivide(
                0.5,
            ),
        };
    }
    ...
    function nonIgnoredElement(nodeContainer) {
        return (
            nodeContainer.node.nodeType !== Node.ELEMENT_NODE || ['SCRIPT', 'HEAD', 'TITLE', 'OBJECT', 'BR', 'OPTION'].indexOf(nodeContainer.node.nodeName) === -1
        );
    }
    ...
    angular.module('ps.presentation').directive('fullscreen', function($mdDialog, env) {
        return {
            ...
            link: function() {
                ...
                var confirm = $mdDialog.confirm().title('Vollbild').textContent('Vollbildmodus anschalten?').ok('Vollbild').cancel('Fenstermodus');
